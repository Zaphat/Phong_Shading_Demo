...
unsigned int Screen::SCR_WIDTH=1920;
unsigned int Screen::SCR_HEIGHT=1080;
...
bool Screen::init()
{
	window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Phong Shading Demo", glfwGetPrimaryMonitor(), NULL);
	if (window == NULL)
	{
		// window not created;
		return false;
